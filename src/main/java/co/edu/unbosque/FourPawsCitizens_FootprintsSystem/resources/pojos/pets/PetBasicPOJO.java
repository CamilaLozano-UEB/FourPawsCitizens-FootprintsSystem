...
public class PetBasicPOJO {
     ...
     */
    public PetBasicPOJO(Integer pet_Id, Long microchip, String name, String species, String race, String size, String sex, String picture) {
        this.pet_id = pet_Id;
